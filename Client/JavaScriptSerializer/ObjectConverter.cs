namespace Justin.Serialization.Json
{
    ...
    internal static class ObjectConverter
    {
        ...
        private const string JSON_NoConstructor = "No Constructor";
        private const string JSON_DeserializerTypeMismatch = "Deserializer Type Mismatch";
        private const string JSON_CannotCreateListType = "Cannot Create List Type";
        private const string JSON_ArrayTypeNotSupported = "Array Type Not Supported";
        private const string JSON_CannotConvertObjectToType = "Cannot Convert Object ToType";
        private const string JSON_ValueTypeCannotBeNull = "Value Type Cannot BeNull";
