namespace Justin.Serialization.Json
{
    ...
    {
        private const string JSON_BadEscape = "bad escape";
        private const string JSON_IllegalPrimitive = "illegal primitive";
        private const string JSON_StringNotQuoted = "String Not Quoted";
        private const string JSON_ExpectedOpenBrace = "Expected Open Brace";
        private const string JSON_InvalidMemberName = "Invalid Member Name";
        private const string JSON_InvalidObject = "Invalid Object";
        private const string JSON_DepthLimitExceeded = "DepthLimit Exceeded";
        private const string JSON_InvalidArrayStart = "Invalid Array Start";
        private const string JSON_InvalidArrayExpectComma = "Invalid Array ExpectComma";
        private const string JSON_InvalidArrayExtraComma = "Invalid Array ExtraComma";
        private const string JSON_InvalidArrayEnd = "Invalid Array End";
        private const string JSON_UnterminatedString = "Unterminated String";
