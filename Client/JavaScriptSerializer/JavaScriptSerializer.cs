namespace Justin.Serialization.Json
{
    ...
    {
        private const string JSON_MaxJsonLengthExceeded = "json max length exceeded";
        private const string JSON_DictionaryTypeNotSupported = "dictionary type not supported";
        private const string JSON_DepthLimitExceeded = "depth limit exceeded";
        private const string JSON_InvalidEnumType = "invalid enum type";
        private const string JSON_CircularReference = "circular reference";
        private const string JSON_InvalidMaxJsonLength = "invalid max json length";
        private const string JSON_InvalidRecursionLimit = "invalid recursion limit";
        ...
        private void SerializeCustomObject(object o, StringBuilder sb, int depth, Hashtable objectsInUse, SerializationFormat serializationFormat)
        {
            ...
            var indent2 = string.Empty.PadLeft(Math.Max(0, depth - 1), '\t');
            bool flag = true;
            Type type = o.GetType();
            sb.Append('{');
            ...
            sb.AppendLine().Append(indent2).Append('}');
        }
